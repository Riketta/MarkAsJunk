...
[b]Smelter bills[/b]
[list][*]Electric smelters gain "smelt/destroy junk" (smeltable things return part of their resources, everything else is destroyed) and "destroy junk" (much faster, no resources). Both bills consume whole stacks and feed exclusively on marked items.[/list]
